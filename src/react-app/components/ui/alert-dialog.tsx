...
function AlertDialogOverlay({
  ...
  return (
    <AlertDialogPrimitive.Backdrop
      ...
      className={cn(
        "data-open:animate-in data-open:fade-in-0 data-closed:animate-out data-closed:fade-out-0 fixed inset-0 isolate z-50 bg-black/10 duration-100 data-closed:pointer-events-none data-ending-style:pointer-events-none supports-backdrop-filter:backdrop-blur-xs",
        className,
      )}
      {...props}
    />
